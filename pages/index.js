...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Shinesheray Myeza Mini Portfolio</title>
    ...
    {/**Main section */}
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className='h-screen'>
          ...
          <nav className='py-10 mb-12 flex justify-between'>
            ...
            <ul className='flex items-center'>
             ...
             <li>
              <a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8' href="https://www.linkedin.com/in/shinesheray-myeza-7b5273120/" target="_blank">LinkedIn</a>
              </li>
            </ul>
          </nav>
          ...
          <AiFillLinkedin/>
            ...
            <div class="relative">
              <Image class="rounded-full  mx-auto border w-80 h-80 mt-19 overflow-hidden" src={shineshery} objectfit="cover"/>
            </div>
        </section>
        ...
        <section>
          ...
          <Image src={code} width={100} hieght={100} className="mt-40"/>
